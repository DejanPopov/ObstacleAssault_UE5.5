...
struct Z_Construct_UClass_AMovingPlatform_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_DistancePassed_MetaData[] = {
		{ "Category", "Moving PLatform" },
		{ "ModuleRelativePath", "MovingPlatform.h" },
	};
#endif // WITH_METADATA
	static const UECodeGen_Private::FStructPropertyParams NewProp_PlatformVelocity;
	static const UECodeGen_Private::FFloatPropertyParams NewProp_DistancePassed;
...
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_AMovingPlatform_Statics::NewProp_DistancePassed = { "DistancePassed", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AMovingPlatform, DistancePassed), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_DistancePassed_MetaData), NewProp_DistancePassed_MetaData) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_AMovingPlatform_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AMovingPlatform_Statics::NewProp_DistancePassed,
};
...
struct Z_CompiledInDeferFile_FID_UE_Projects_ObstacleAssault_UE5_5_ObstacleAssault_Source_ObstacleAssault_MovingPlatform_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_AMovingPlatform, AMovingPlatform::StaticClass, TEXT("AMovingPlatform"), &Z_Registration_Info_UClass_AMovingPlatform, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AMovingPlatform), 1587033258U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UE_Projects_ObstacleAssault_UE5_5_ObstacleAssault_Source_ObstacleAssault_MovingPlatform_h_3829901614(TEXT("/Script/ObstacleAssault"),
